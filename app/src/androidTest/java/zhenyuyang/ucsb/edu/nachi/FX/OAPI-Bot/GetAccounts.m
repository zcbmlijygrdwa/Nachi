...
AccountCells = RawAccounts.account;
%% OutPut Assignment
...
% end
    ...
    AccountList.accountId = num2str(AccountCells.id);
    AccountList.accountName = AccountCells.alias;
    AccountList.accountCurrency = AccountCells.currency;
    AccountList.marginRate = AccountCells.marginRate;
    AccountList.balance = AccountCells.balance;
    AccountList.marginAvailable = AccountCells.marginAvailable;
    
    if isfield(AccountCells,'NAV')
        AccountList.NAV = AccountCells.NAV;
    end
