...
%     clear dataComp;
    ...
    dispPriod = 200;
    try
    [a,b,c,d] = textread(['/home/ob7/Downloads/fxTempData/' fileName '.csv'],'%s %s %s %s','delimiter',',','headerlines',1);
    catch
        disp(['Error in reading ' num2str(year) ' year, ' num2str(iii) 'month...'])
        continue;
    end
    ...
    fileID = fopen(['/home/ob7/fx_EUR_USD_tick/' fileName '_converted.txt'],'a');
